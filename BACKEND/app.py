...
creds = ServiceAccountCredentials.from_json_keyfile_name('peaceful-fact-428901-n3-9aef14c7efa5.json', scope)
client = gspread.authorize(creds)

# Firebase와 CSV 파일 경로 설정
firebase_key_path = 'C:/projects/pododoc/BACKEND/kosmo-96bbe-firebase-adminsdk-8qv6s-e1a5c7d126.json'
...
Clean_Red_data = pd.read_excel('Clean_Red_data.xlsx', engine='openpyxl')
Clean_White_data = pd.read_excel('Clean_White_data.xlsx', engine='openpyxl')
Combined_Wine_data = pd.read_excel('Combined_Wine_Data.xlsx', engine='openpyxl')
...
# CORS 설정 (특정 도메인만 허용)
# CORS(app, resources={r"/*": {"origins": "http://192.168.0.9"}})
